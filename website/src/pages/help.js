...
function Help() {
  ...
  const supportLinks = [
    ...
    {
      content: '[Ask questions](https://github.com/terascope/file-assets/issues) about the documentation and project',
      title: 'Join the community',
    },
    {
      content: '[Find out](https://github.com/terascope/file-assets/releases) what\'s new with this project',

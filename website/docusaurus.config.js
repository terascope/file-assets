...
module.exports = {
    ...
    projectName: 'file-assets',
    scripts: [
        'https://buttons.github.io/buttons.js',
        'https://cdnjs.cloudflare.com/ajax/libs/clipboard.js/2.0.0/clipboard.min.js',
        '/file-assets/js/copy-code-block.js'
    ],
    stylesheets: [
        {
            href: '/file-assets/css/custom.css',
            type: 'text/css',
            rel: 'stylesheet'
        }
    ],
    ...
    themeConfig: {
        ...
        navbar: {
            ...
            items: [
                ...
                {
                    href: 'https://github.com/terascope/file-assets',
                    label: 'GitHub',
                    position: 'left'
                },
                {
            ...
            links: [
                ...
                },
                {
                    ...
                    items: [
                        {
                            label: 'Github',
                            to: 'https://github.com/terascope/file-assets',
                        },
                        {
        ...
        algolia: {
            ...
            indexName: 'terascope_teraslice_file-assets',

...
import Processor from '../../asset/src/file_exporter/processor';

function getTestFilePath(...parts: string[]) {
...
describe('File exporter processor', () => {
    ...
    const context = new TestContext('file-reader', { assignment: 'worker' });
    // This sets up the opconfig for the first test
    // TODO: why is this not using worker test harness???
    // @ts-ignore
